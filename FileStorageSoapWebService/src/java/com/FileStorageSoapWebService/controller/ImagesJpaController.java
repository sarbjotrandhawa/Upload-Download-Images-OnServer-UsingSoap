 ...
 */
package com.FileStorageSoapWebService.controller;

import com.FileStorageSoapWebService.controller.exceptions.NonexistentEntityException;
import com.FileStorageSoapWebService.controller.exceptions.PreexistingEntityException;
...
public class ImagesJpaController implements Serializable {
    ...
    {
        EntityManager em = getEntityManager();
        Query query = em.createNamedQuery("Images.findAll");
